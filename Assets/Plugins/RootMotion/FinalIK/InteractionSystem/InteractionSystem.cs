...
namespace RootMotion.FinalIK {
	...
	public class InteractionSystem : MonoBehaviour {
		...
		[ShowInInspector]public List<InteractionTrigger> triggersInRange { get; private set; }
        ...
        public void Start()
        {
	        ...
	        ActorBase actorBase = ActorUtilities.FindFirstActorInParents(transform);
	        if (actorBase != null)
	        {
		        fullBody = actorBase.GetComponentInChildren<FullBodyBipedIK>();
		        characterCollider = actorBase.GetComponent<Collider>();
	        }
	        else
	        { 
		        if(fullBody == null)
